...
class $MenuItemsTableTable extends MenuItemsTable
    with TableInfo<$MenuItemsTableTable, MenuItem> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class MenuItem extends DataClass implements Insertable<MenuItem> {
  ...
  MenuItem copyWithCompanion(MenuItemsTableCompanion data) {
    return MenuItem(
      id: data.id.present ? data.id.value : this.id,
...
class MenuItemsTableCompanion extends UpdateCompanion<MenuItem> {
  final Value<int> id;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('menu_items_table', kind: UpdateKind.update)],
    ),
  ]);
}
...
final class $$CategoriesTableTableReferences
  ...
  static MultiTypedResultKey<$MenuItemsTableTable, List<MenuItem>>
  _menuItemsTableRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.menuItemsTable,
    aliasName: 'categories_table__id__menu_items_table__category_id',
  );

  $$MenuItemsTableTableProcessedTableManager get menuItemsTableRefs {
    final manager = $$MenuItemsTableTableTableManager(
      $_db,
      $_db.menuItemsTable,
    ).filter((f) => f.categoryId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_menuItemsTableRefsTable($_db));
...
class $$CategoriesTableTableFilterComposer
  ...
  Expression<bool> menuItemsTableRefs(
    Expression<bool> Function($$MenuItemsTableTableFilterComposer f) f,
  ) {
    final $$MenuItemsTableTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.menuItemsTable,
...
class $$CategoriesTableTableAnnotationComposer
  ...
  Expression<T> menuItemsTableRefs<T extends Object>(
    Expression<T> Function($$MenuItemsTableTableAnnotationComposer a) f,
  ) {
    final $$MenuItemsTableTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.menuItemsTable,
      getReferencedColumn: (t) => t.categoryId,
...
class $$CategoriesTableTableTableManager
    extends
        RootTableManager<
          ...
          Category,
          PrefetchHooks Function({bool menuItemsTableRefs})
        > {
    ...
    $CategoriesTableTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({menuItemsTableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (menuItemsTableRefs) db.menuItemsTable,
              ],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (menuItemsTableRefs)
...
final class $$MenuItemsTableTableReferences
    extends BaseReferences<_$AppDatabase, $MenuItemsTableTable, MenuItem> {
  $$MenuItemsTableTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $CategoriesTableTable _categoryIdTable(_$AppDatabase db) => db
      .categoriesTable
      .createAlias('menu_items_table__category_id__categories_table__id');
...
class $$MenuItemsTableTableTableManager
    extends
        RootTableManager<
          ...
          (MenuItem, $$MenuItemsTableTableReferences),
          MenuItem,
                    ...
                    if (categoryId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$MenuItemsTableTableReferences
                                    ._categoryIdTable(db),
                                referencedColumn:
                                    $$MenuItemsTableTableReferences
                                        ._categoryIdTable(db)
